...
namespace System.Web.Mvc
{
    ...
    public class AjaxFormOptions
    {
        ...
        public IDictionary<string, object> ToHtmlAttributes()
        {
            ...
            data.Add("target", this.Target);
            data.Add("replaceTarget", this.ReplaceTarget);
            if (this.Method.HasValue)
                data.Add("type", this.Method.Value == FormMethod.Post ? "POST" : "GET");
            ...
            data.Add("beforeSubmitFn", this.BeforeSubmitCallBack);
            data.Add("successFn", this.OnSuccessCallBack);
            data.Add("errorFn", this.OnErrorCallBack);
            data.Add("resetForm", this.ResetForm);
            data.Add("clearForm", this.ClearForm);
            data.Add("closeDialog", this.CloseDialog);
            data.Add("data", this.ExtraData);
